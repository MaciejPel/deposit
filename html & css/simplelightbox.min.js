...
function _unsupportedIterableToArray(t, e) {
	if (t) {
		...
		return "Object" === i && t.constructor && (i = t.constructor.name), "Map" === i || "Set" === i ? Array.from(i) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? _arrayLikeToArray(t, e) : void 0;
	}
}
...
var SimpleLightbox = (function () {
	function n(t, e) {
		...
		_classCallCheck(this, n),
			...
			_defineProperty(this, "v", { a: 0, b: 0, c: 0, d: 0, e: 0, f: 0, g: !1, h: 0, i: !1, j: 0, k: 0, l: 0, m: 0, n: 0, o: 0, p: !1, q: 0, r: 0, s: 0, t: 0, u: 0, v: 0, w: 1, x: 0, y: 0, z: 0, A: 0, B: 0, C: 0, D: 0, E: 0, F: 0, G: 0, H: 0, I: 0, J: 0, K: 0, L: 0, M: !1, N: 0 }),
			(this.options = Object.assign(this.a, e)),
			"string" == typeof t ? ((this.t = t), (this.elements = Array.from(document.querySelectorAll(t)))) : (this.elements = void 0 !== t.length && 0 < t.length ? Array.from(t) : [t]),
			...
			this.options.docClose &&
				this.addEventListener(this.p.e, ["click." + this.o, "touchstart." + this.o], function (t) {
					i.g && i.close();
				}),
			this.options.disableRightClick &&
				this.addEventListener(document.body, "contextmenu." + this.o, function (t) {
		...
		_createClass(n, [
			{
				...
				value: function () {
					(this.p.e = document.createElement("div")),
						...
						(this.p.c.innerHTML = '<button class="sl-prev">'.concat(this.options.navText[0], '</button><button class="sl-next">').concat(this.options.navText[1], "</button>")),
						(this.p.f = document.createElement("div")),
						this.p.f.classList.add("sl-counter"),
						(this.p.f.innerHTML = '<span class="sl-current"></span>/<span class="sl-total"></span>'),
			...
			},
			{
				...
				value: function () {
					...
					this.fadeOut(document.querySelectorAll(".sl-image img, .sl-overlay, .sl-close, .sl-navigation, .sl-image .sl-caption, .sl-counter"), 300, function () {
						t.options.disableScroll && t.toggleScrollbar("show"), t.options.htmlClass && "" !== t.options.htmlClass && document.querySelector("html").classList.remove(t.options.htmlClass), document.body.removeChild(t.p.a), document.body.removeChild(t.p.e), (t.p.i = null), e.dispatchEvent(new Event("closed.simplelightbox")), (t.i = !1);
					}),
					(this.n = null),
					(this.g = !1),
					(this.h = !1),
			...
			},
			{
				...
				value: function () {
					...
					o.addEventListener("load", function (t) {
						...
						-1 === i.q.indexOf(e) && i.q.push(e), i.relatedElements[n].dispatchEvent(new Event("nextImageLoaded." + i.o));
					}),
						o.setAttribute("src", this.relatedElements[e].getAttribute(this.options.sourceAttr)),
						a.addEventListener("load", function (t) {
							var e = t.target.getAttribute("src");
							-1 === i.q.indexOf(e) && i.q.push(e), i.relatedElements[n].dispatchEvent(new Event("prevImageLoaded." + i.o));
						}),
			...
			},
			{
				...
				value: function (t) {
					...
					(this.nIndex = n < 0 ? this.relatedElements.length - 1 : n > this.relatedElements.length - 1 ? 0 : n),
						(this.p.f.querySelector(".sl-current").innerHTML = this.nIndex + 1),
						this.options.animationSlide && this.slide(this.options.animationSpeed / 1e3, -100 * i - this.v.a + "px"),
						this.fadeOut(this.p.h, 300, function () {
							(e.h = !0),
								setTimeout(function () {
									var t = e.relatedElements[e.nIndex];
									e.n.setAttribute("src", t.getAttribute(e.options.sourceAttr)), -1 === e.q.indexOf(t.getAttribute(e.options.sourceAttr)) && e.show(e.p.d), e.p.h.contains(e.p.g) && e.p.h.removeChild(e.p.g), e.adjustImage(i), e.options.preloading && e.preload();
								}, 100);
						});
				},
			},
				...
				value: function (a) {
					...
					t.setAttribute("src", this.n.getAttribute("src")),
						...
						t.addEventListener("error", function (t) {
							r.relatedElements[r.nIndex].dispatchEvent(new Event("error." + r.o)), (r.h = !1), (r.g = !1), (r.p.d.style.display = "none");
							var e = 1 === a || -1 === a;
						...
						t.addEventListener("load", function (t) {
							...
							(r.p.h.style.top = (window.innerHeight - i) / 2 + "px"), (r.p.h.style.left = (window.innerWidth - e - r.u) / 2 + "px"), (r.p.h.style.width = e + "px"), (r.p.h.style.height = i + "px"), (r.p.d.style.display = "none"), r.fadeIn(r.n, 300), (r.g = !0);
							var s,
								o = "self" === r.options.captionSelector ? r.relatedElements[r.nIndex] : r.relatedElements[r.nIndex].querySelector(r.options.captionSelector);
							r.options.captions && o && (s = "data" === r.options.captionType ? o.dataset[r.options.captionsData] : "text" === r.options.captionType ? o.innerHTML : o.getAttribute(r.options.captionsData)),
								r.options.loop || (0 === r.nIndex && r.hide(r.p.c.querySelector(".sl-prev")), r.nIndex >= r.relatedElements.length - 1 && r.hide(r.p.c.querySelector(".sl-next")), 0 < r.nIndex && r.show(r.p.c.querySelector(".sl-prev")), r.nIndex < r.relatedElements.length - 1 && r.show(r.p.c.querySelector(".sl-next"))),
								1 === r.relatedElements.length ? r.hide(r.p.c.querySelectorAll(".sl-prev, .sl-next")) : r.show(r.p.c.querySelectorAll(".sl-prev, .sl-next")),
								1 === a || -1 === a
									...
									: ((r.h = !1), r.setCaption(s, e)),
								r.options.additionalHtml && !r.p.i && ((r.p.i = document.createElement("div")), r.p.i.classList.add("sl-additional-html"), (r.p.i.innerHTML = r.options.additionalHtml), r.p.h.appendChild(r.p.i));
						});
				},
			},
			{
			...
			},
			{
				...
				value: function () {
					...
					this.addEventListener(window, "resize." + this.o, function (t) {
						...
						this.addEventListener(this.p.c.getElementsByTagName("button"), "click." + this.o, function (t) {
						...
						this.addEventListener(this.p.h, ["touchstart." + this.o, "mousedown." + this.o], function (t) {
							...
							if ("mousedown" === t.type) (i.v.s = t.clientX), (i.v.t = t.clientY), (i.v.j = i.getDimensions(i.p.h).height), (i.v.k = i.getDimensions(i.p.h).width), (i.v.n = i.getDimensions(i.n).height), (i.v.o = i.getDimensions(i.n).width), (i.v.l = i.p.h.offsetLeft), (i.v.m = i.p.h.offsetTop), (i.v.q = parseFloat(i.n.dataset.translateX)), (i.v.r = parseFloat(i.n.dataset.translateY)), (i.v.p = !0);
								...
								if (((i.v.L = t.touches.length), (i.v.s = t.touches[0].clientX), (i.v.t = t.touches[0].clientY), (i.v.j = i.getDimensions(i.p.h).height), (i.v.k = i.getDimensions(i.p.h).width), (i.v.n = i.getDimensions(i.n).height), (i.v.o = i.getDimensions(i.n).width), (i.v.l = i.p.h.offsetLeft), (i.v.m = i.p.h.offsetTop), 1 === i.v.L)) {
									if (i.v.M)
										return (
											...
											i.v.i ? ((i.v.w = 1), i.setZoomData(i.v.w, 0, 0), i.zoomPanElement("0px", "0px", i.v.w), (i.v.i = !1)) : ((i.v.w = i.options.doubleTapZoom), i.setZoomData(i.v.w, 0, 0), i.zoomPanElement("0px", "0px", i.v.w), i.p.g.style.opacity || "none" === i.p.g.style.display || i.fadeOut(i.p.g, 200), (i.v.i = !0)),
											setTimeout(function () {
								...
								} else 2 === i.v.L && ((i.v.s2 = t.touches[1].clientX), (i.v.t2 = t.touches[1].clientY), (i.v.q = parseFloat(i.n.dataset.translateX)), (i.v.r = parseFloat(i.n.dataset.translateY)), (i.v.F = (i.v.s + i.v.s2) / 2), (i.v.G = (i.v.t + i.v.t2) / 2), (i.v.x = Math.sqrt((i.v.s - i.v.s2) * (i.v.s - i.v.s2) + (i.v.t - i.v.t2) * (i.v.t - i.v.t2))));
								i.v.p = !0;
							}
									...
									1 < i.v.L
										? ((i.v.y2 = t.touches[1].clientX),
										  ...
										  1 <= Math.abs(i.v.x - i.v.K) &&
												((i.v.E = i.minMax((i.v.K / i.v.x) * i.v.w, 1, i.options.maxZoom)),
												...
												1 < i.v.E && ((i.v.i = !0), i.p.g.style.opacity || "none" === i.p.g.style.display || i.fadeOut(i.p.g, 200)),
												(i.v.x = i.v.K),
												(i.v.w = i.v.E),
												(i.v.q = i.v.C),
												(i.v.r = i.v.D)))
										: ((i.v.E = i.v.w),
										  ...
										  Math.abs(i.v.C) === Math.abs(i.v.H) && ((i.v.q = i.v.C), (i.v.s = i.v.y)),
										  Math.abs(i.v.D) === Math.abs(i.v.I) && ((i.v.r = i.v.D), (i.v.t = i.v.z)),
						...
						this.addEventListener(this.p.h, ["touchend." + this.o, "mouseup." + this.o, "touchcancel." + this.o, "mouseleave." + this.o, "pointerup", "pointercancel", "MSPointerUp", "MSPointerCancel"], function (t) {
							if ((i.d && "touchend" === t.type && ((i.v.L = t.touches.length), 0 === i.v.L ? (i.n && i.setZoomData(i.v.w, i.v.C, i.v.D), 1 === i.v.w && ((i.v.i = !1), "none" === i.p.g.style.display && i.fadeIn(i.p.g, 200)), (i.v.x = null), (i.v.p = !1)) : 1 === i.v.L ? ((i.v.s = t.touches[0].clientX), (i.v.t = t.touches[0].clientY)) : 1 < i.v.L && (i.v.x = null)), i.v.g)) {
								var e = !(i.v.g = !1);
								i.options.loop || (0 === i.nIndex && i.v.a < 0 && (e = !1), i.nIndex >= i.relatedElements.length - 1 && 0 < i.v.a && (e = !1)),
						...
						this.addEventListener(this.p.h, ["dblclick"], function (t) {
							if (!i.d)
								return (
									...
									i.n.classList.add("sl-transition"),
									i.v.i ? ((i.v.w = 1), i.setZoomData(i.v.w, 0, 0), i.zoomPanElement("0px", "0px", i.v.w), (i.v.i = !1), "none" === i.p.g.style.display && i.fadeIn(i.p.g, 200)) : ((i.v.w = i.options.doubleTapZoom), i.setZoomData(i.v.w, 0, 0), i.zoomPanElement("0px", "0px", i.v.w), i.p.g.style.opacity || "none" === i.p.g.style.display || i.fadeOut(i.p.g, 200), (i.v.i = !0)),
									setTimeout(function () {
										i.n && i.n.classList.remove("sl-transition");
									}, 200),
									!(i.v.p = !0)
			...
			},
			{
				...
				value: function (t) {
					...
					return { height: i - parseFloat(e.borderBottomWidth) - s - parseFloat(e.paddingTop) - parseFloat(e.paddingBottom), width: n - parseFloat(e.borderLeftWidth) - parseFloat(e.borderRightWidth) - parseFloat(e.paddingLeft) - parseFloat(e.paddingRight) };
				},
			},
			{
				key: "updateHash",
			...
			},
			{
				...
				value: function (t) {
					...
					t.dispatchEvent(new Event("show." + this.o)),
						...
						this.options.showCounter && (1 == this.relatedElements.length && this.p.a.contains(this.p.f) ? this.p.a.removeChild(this.p.f) : 1 < this.relatedElements.length && !this.p.a.contains(this.p.f) && this.p.a.appendChild(this.p.f)),
						(this.h = !0),
					...
					(this.n = document.createElement("img")),
						...
						this.show(this.p.d),
						(this.p.f.querySelector(".sl-current").innerHTML = this.nIndex + 1),
						(this.p.f.querySelector(".sl-total").innerHTML = this.relatedElements.length),
						this.adjustImage(),
						...
						for (o.s(); !(s = o.n()).done; ) {
							...
							try {
								for (l.s(); !(r = l.n()).done; ) {
									var h = r.value,
										v = n || !1;
									(a.namespaces[h] = i), a.addEventListener(h.split(".")[0], i, v);
								}
							} catch (t) {
								l.e(t);
							} finally {
					...
					try {
						for (n.s(); !(i = n.n()).done; ) {
							...
							try {
								for (a.s(); !(s = a.n()).done; ) {
									var r = s.value;
									o.removeEventListener(r.split(".")[0], o.namespaces[r]), delete o.namespaces[r];
								}
							} catch (t) {
								a.e(t);
							} finally {
					...
					try {
						for (i.s(); !(e = i.n()).done; ) {
							...
							try {
								for (o.s(); !(n = o.n()).done; ) {
									var a = n.value;
									void 0 !== s.fullyNamespacedEvents && a in s.fullyNamespacedEvents && s.removeEventListener(a, s.fullyNamespacedEvents[a]);
								}
							} catch (t) {
								o.e(t);
							} finally {
			...
			},
			{
				key: "open",
				value: function (t) {
					(t = t || this.elements[0]), "undefined" != typeof jQuery && t instanceof jQuery && (t = t.get(0)), (this.r = this.elements.indexOf(t)), -1 < this.r && this.openImage(t);
				},
			},
			{
				key: "next",
			...
			},
			{
				...
				value: function () {
					this.off(["close." + this.o, "closed." + this.o, "nextImageLoaded." + this.o, "prevImageLoaded." + this.o, "change." + this.o, "nextDone." + this.o, "prevDone." + this.o, "error." + this.o, "changed." + this.o, "next." + this.o, "prev." + this.o, "show." + this.o, "shown." + this.o]),
						...
						this.removeEventListener(this.p.c.getElementsByTagName("button"), "click." + this.o),
						...
						this.close(),
						this.g && (document.body.removeChild(this.p.a), document.body.removeChild(this.p.e)),
						(this.elements = null);
				},
			},
			{
